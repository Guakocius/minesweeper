...
The graphics of the GUI is made by [modelivesky](https://modelivesky.com/), if you want to download it click [on this link](https://modelivesky.itch.io/minesweeperpack)

## If you want to know how this Project is structured you can see it [under the following link](https://github.com/Atomarverseucht/minesweeper/tree/main/src/main/scala/de/htwg/winesmeeper)
